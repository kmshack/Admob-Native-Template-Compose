...
```kotlin
dependencies {
    implementation("com.github.kmshack:Admob-Native-Template-Compose:1.2.0")
}
```
...
"Admob-Native-Template-Compose" library (version 1.2.0).
...
2. **Version Specific**: Always mention library version (1.2.0) to get accurate syntax
