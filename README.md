...
```kotlin
dependencies {
    implementation("com.github.kmshack:Admob-Native-Template-Compose:1.1.7")
}
```
...
"Admob-Native-Template-Compose" library (version 1.1.7).
...
2. **Version Specific**: Always mention library version (1.1.7) to get accurate syntax
