...
```kotlin
dependencies {
    implementation("com.github.kmshack:Admob-Native-Template-Compose:1.1.4")
}
```
...
"Admob-Native-Template-Compose" library (version 1.1.4).
...
2. **Version Specific**: Always mention library version (1.1.4) to get accurate syntax
