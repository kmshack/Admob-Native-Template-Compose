...
```kotlin
dependencies {
    implementation("com.github.kmshack:Admob-Native-Template-Compose:1.1.6")
}
```
...
"Admob-Native-Template-Compose" library (version 1.1.6).
...
2. **Version Specific**: Always mention library version (1.1.6) to get accurate syntax
